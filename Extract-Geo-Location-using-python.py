...
# Open the CSV file
reader = csv.reader(open('Z:\\UTD\\SEM 1\\Data Viz\\Assignments\\Assignment 4\\Largest_Cities_CSV.csv'), delimiter=",")
...
mycsv = csv.writer(open('Z:\\UTD\SEM 1\Data Viz\Assignments\Assignment 4\FinalList.csv','w'))
for row in list1:
